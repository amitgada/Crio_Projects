...
public class QKART_Tests {
     ...
     */
        ...
        //  ? "PASS" : "FAIL");
        Assert.assertTrue(status, "Logout unsuccessfull");
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
        ...
        */
        ...
        //Assert.assertTrue(!status, "Re-registration successful");
    }
     /*
    ...
    public void TestCase03(String product) throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            Assert.assertTrue(status, "Result not matching searched text");
        ...
        Assert.assertTrue(searchResults.size() == 0, "Search result is not zero");
    ...
    public void TestCase04(@Optional("Running Shoes") String product) throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                Assert.assertTrue(status, "Size Chart Link not found");
                // Verify if size dropdown exists
                status = result.verifyExistenceofSizeDropdown(driver);
                //logStatus("Step Success", "Validated presence of drop down", status ? "PASS" : "FAIL");
                Assert.assertTrue(status, "Failure to open Size Chart");
                // Open the size chart
                if (result.openSizechart()) {
                    ...
                    //     status = false;
                    Assert.assertTrue(status, "Size Chart Link does not exist");
                    }
    ...
    @Test (groups = {"Sanity"}, description = "Verify that a new user can add multiple products in to the cart and Checkout", priority = 5)
    public void TestCase05(String product2, String product3, String address) throws InterruptedException {
        ...
        // }
        Assert.assertTrue(status, "Registration not successfull");
        ...
        // }
        Assert.assertTrue(status, "Login not successfull");
        ...
        // return status;
        Assert.assertTrue(status, "Happy Flow Test not Completed");
    }
    /*
     * Verify the quantity of items in cart can be updated
     */
    @Parameters ({"product4", "product5"})
    @Test (groups = {"Regression"}, description = "Verify that the contents of the cart can be edited", priority = 6)
    public void TestCase06(String product4, String product5) throws InterruptedException {
        ...
        // logStatus("End TestCase", "Test Case 6: Verify that cart can be edited: ", status ? "PASS" : "FAIL");
        // return status;
        Assert.assertTrue(status, "Failed to Verify that cart can be edited");
    }
    /*
     * Verify that the cart contents are persisted after logout
     */
    @Parameters ({"product6", "product4"})
    ...
    public void TestCase07(String product6, String product4) throws InterruptedException {
        Boolean status = false;
        ...
        //         status ? "PASS" : "FAIL");
        Assert.assertTrue(status, "cart contents are not persisted after logout");
    ...
    public void TestCase08(String product6, int qty) throws InterruptedException {
        ...
        // return status;
        Assert.assertTrue(status, "Insufficient balance error is not thrown");
    }
    ...
    public void TestCase09() throws InterruptedException {
        ...
        // return status;
        Assert.assertTrue(status, "Product not present in the new tab");
    }
    ...
    public void TestCase10() throws InterruptedException {
        ...
        //             status ? "PASS" : "FAIL");
        // }
        Assert.assertTrue(status, "Page url didn't change on privacy policy link click failed");
        ...
        // return status;
        Assert.assertTrue(status, "Privacy Policy, About Us are not displayed correctly");
    }
    ...
    public void TestCase11(String ContactusUserName, String ContactUsEmail, String QueryContent) throws InterruptedException {
        ...
        // return true;
        Assert.assertTrue(status, "contact us option is not working correctly");
    }
    @Parameters ({"product2", "address"})
    @Test (groups = {"Sanity"}, description = "Ensure that the Advertisement Links on the QKART page are clickable", priority = 12)
    public void TestCase12(String product2, String address) throws InterruptedException {
        Boolean status = false;
        // logStatus("Start TestCase",
        ...
        homePage.addProductToCart(product2);
        homePage.changeProductQuantityinCart(product2, 1);
        homePage.clickCheckout();
        ...
        //         status ? "PASS" : "FAIL");
        // return status;
        Assert.assertTrue(status, "QKART advertisement are not clickable");
    }
}
